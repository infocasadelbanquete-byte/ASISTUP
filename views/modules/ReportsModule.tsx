    ...
    <div className="space-y-8 fade-in">
      <div className="flex justify-between items-center bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100">
        ...
        <div className="flex gap-3">
          ...
          }} className="px-6 py-4 bg-emerald-600 text-white font-black rounded-2xl shadow-xl uppercase text-[10px] tracking-widest no-print">Exportar Excel</button>
          <button onClick={() => window.print()} className="px-8 py-4 bg-slate-900 text-white font-black rounded-2xl shadow-xl uppercase text-[10px] tracking-widest no-print">Imprimir Documento</button>
        </div>
      </div>
              ...
              <div className="space-y-6">
                ...
                {pendingAttendance.length === 0 ? (
                  <div className="py-20 text-center bg-slate-50 rounded-3xl border-2 border-dashed">
                    <p className="text-slate-400 font-black uppercase text-xs">Sin pendientes en la cola.</p>
                  </div>
                ) : (
